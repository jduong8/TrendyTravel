...
@MainActor class UserViewModel: ObservableObject {
    ...
    @Published var user: User = User(id: 0, firstName: "john", lastName: "doe", description: "hello I'm new", profilImage: "billy", pseudo: "jo.D", password: "kkk", email: "jo.d@gmail.com", posts: [Post(id: 0, title: "1st post", imageName: "eiffel_tower", hashtags: ["paradise", "lost"], userID: 0)], followers: [])
    ...
    func getUsers() async throws -> [User] {
        ...
        let sortedUsers = users.sorted {
            $0.followers?.count ?? 0 > $1.followers?.count ?? 0
        }
        return sortedUsers
    }
